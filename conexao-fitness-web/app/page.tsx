      ...
      <section className="pt-24 bg-[#12151c] relative overflow-hidden border-t border-slate-800">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 pb-24 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a 
              href="https://wa.me/5551991562823?text=Ol%C3%A1!%20Gostaria%20de%20conversar%20com%20um%20especialista%20do%20Conex%C3%A3o%20Fitness" 
              target="_blank" 
              rel="noreferrer" 
              className="h-14 bg-transparent hover:bg-slate-800 border border-emerald-500/50 text-white hover:text-emerald-400 px-8 rounded-lg font-bold transition-all flex items-center justify-center gap-2"
            >
        ...
        <footer className="border-t border-slate-800 bg-[#12151c] py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="text-white font-bold mb-4">Contato & Suporte</h4>
              <ul className="space-y-3 text-sm">
                <li>
                  <a
                    href="https://wa.me/5551991562823?text=Ol%C3%A1!%20Vim%20pelo%20site%20Conex%C3%A3o%20Fitness"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  >
                    ...
                    <span>(51) 99156-2823</span>
                  </a>
                </li>
                <li className="text-slate-400">contato@conexaofitness.com.br</li>
                <li className="text-slate-500 text-xs">Uruguaiana, RS - Brasil</li>
              </ul>
            </div>
          </div>
        </footer>
