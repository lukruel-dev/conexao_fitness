...
export default function Carteira() {
  ...
  if (user?.role === "ACADEMIA") {
    return (
      <div className="min-h-screen bg-background flex flex-col">
        <Header />
        <main className="flex-1 container mx-auto px-4 pt-28 sm:pt-32 md:pt-36 pb-16 max-w-5xl">
          <AcademiaWalletView />
        </main>
        <Footer />
      </div>
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Header />
      <main className="flex-1 container mx-auto px-4 pt-28 sm:pt-32 md:pt-36 pb-16 max-w-4xl">
