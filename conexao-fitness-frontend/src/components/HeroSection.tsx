    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-[calc(5rem+max(24px,env(safe-area-inset-top)))] pb-[calc(5rem+max(16px,env(safe-area-inset-bottom)))]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          {/* Headline */}
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            Encontre seu{" "}
          ...
          {/* Search Bar */}
          <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-3 border border-border shadow-card max-w-xl animate-fade-in-up mb-8" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-xl animate-fade-in-up" style={{ animationDelay: "0.35s" }}>
             <Button variant="default" size="lg" className="w-full text-lg h-14" asChild>
          ...
          {/* Trust Badges */}
          <div className="flex flex-wrap items-center gap-6 mt-8 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-full gradient-primary flex items-center justify-center text-primary-foreground font-bold">
                50+
              </div>
              <span className="text-sm text-muted-foreground">Academias parceiras</span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">Personal trainers</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center">
                ⭐
              </div>
              <span className="text-sm text-muted-foreground">4.9 avaliação média</span>
            </div>
          </div>
        </div>
      </div>
