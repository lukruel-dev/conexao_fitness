...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border flex justify-around items-center h-16 md:hidden shadow-[0_-4px_10px_rgba(0,0,0,0.1)]">
