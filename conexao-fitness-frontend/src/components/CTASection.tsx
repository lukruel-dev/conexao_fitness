      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <Button asChild variant="heroOutline" size="xl" className="w-full sm:w-auto text-base sm:text-lg h-12 sm:h-14 px-6 whitespace-normal leading-snug hover:border-emerald-500/50 hover:text-emerald-500">
              <a href="https://wa.me/5551991562823?text=Ol%C3%A1!%20Gostaria%20de%20tirar%20d%C3%BAvidas%20sobre%20o%20Conex%C3%A3o%20Fitness" target="_blank" rel="noreferrer" className="flex items-center gap-2">
